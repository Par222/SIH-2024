    ...
    <>
      {showBot ? (
        <>
          ...
          >
            <div className="flex justify-between items-center px-4 py-3 bg-yellow-200">
            ...
            <div className=" absolute bottom-0 w-full "><BotDetail person={person} msgArray={msgArray} set={(msg,isLoading) => {
